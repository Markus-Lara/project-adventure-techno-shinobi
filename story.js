...
storyContainer.addEventListener("click", function() {
    dialogue.innerHTML = story.intro.text

let presentStory = story[story.length-1] //presentStory is set to lat index of history array
storyContainer.innerHTML = ; //sets text to null
});